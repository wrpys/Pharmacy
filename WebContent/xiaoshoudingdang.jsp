...
{{#userList}}
<tr role="row" class="user-name odd" data-id="{{xiaoshoudingdangID}}"><!--even -->
    <td><a href="#" class="user-edit" data-id="{{xiaoshoudingdangID}}">{{xiaoshoudingdangID}}</a></td>
    <td>{{yaopingID}}</td>
    <td>{{yaopingMingzi}}</td>
    <td>{{yaopingDanwei}}</td>
	<td>{{shuliang}}</td>
    ...
    <td>
        <div class="hidden-sm hidden-xs action-buttons">
            <a class="green user-edit" href="#" data-id="{{xiaoshoudingdangID}}"
			...
			data-riqi="{{riqi}}">
             ...
             <a class="red user-delete" href="#" data-id="{{xiaoshoudingdangID}}" >
...
$(function () {
    ...
    function loadUserList() {
        ...
        $.ajax({
        	url: url,
        	data:{cls:'XiaoshoudingdangController',mtd:'findALL'},            
    ...
    function renderUserListAndPage(result) {   
		 var rendered = Mustache.render(userListTemplate, {"userList": result.xiaoshoudingdangList,
    ...
    function bindUserClick() {
        ...
        $(".user-edit").click(function (e) {
            var xiaoshoudingdangID = $(this).attr("data-id"); // 选中的id
            ...
            $("#dialog-updateuser-form").dialog({
				...
				$("#xiaoshoudingdangID").val(xiaoshoudingdangID);
        ...
        $(".user-delete").click(function (e) {
            ...
            var xiaoshoudingdangID = $(this).attr("data-id");
            if (confirm("确定要删除吗?")) {
                $.ajax({
                    url: "${pageContext.request.contextPath }/cs",
                    data: {
                    	cls:'XiaoshoudingdangController',mtd:'delete',
                    	xiaoshoudingdangID: xiaoshoudingdangID
                    },
                    success: function () {
